...
## backend:
  ...
  - task: "Python 3.13 migration + omniparse across ALL formats (images + Word/PDF/Excel)"
    ...
    status_history:
        ...
        -working: true
        -agent: "testing"
        -comment: "REGRESSION TEST PASSED - 9/9 tests. No regression after the numpy 2.x / opencv 5.x / onnxruntime 1.27 / pillow 12.x upgrade. Health + ready + auth OK. Omniparse verified across formats: PNG/JPG images (ocrUsed=true), DOCX + XLSX via MarkItDown (ocrUsed=false), CSV (ocrUsed=false), and scanned PDF /app/de_scan.pdf (ocrUsed=true, ocrEngine='paddleocr:latin', German umlauts München/Straße/schön/Müller + English 2025/OK all present)."
        -working: true
        -agent: "testing"
